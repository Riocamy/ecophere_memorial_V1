...
define config.name = _("Prologue : Le Mémorial")
...
define build.name = "Ecosphere_Le_Memorial_FR"
...
#define config.main_menu_music = "audio/horizon.WAV"
...
define config.save_directory = "Ecosphere_Le_Memorial_FR-1623164410"
